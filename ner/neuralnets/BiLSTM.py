...
class BiLSTM:
	...
	def plot_noise_dists(self, test_score):
		...
		pylab.xticks(np.arange(0, self.num_classes), labels=list(self.mappings['NER_BIO'].keys()))
		pylab.yticks(np.arange(0, self.num_classes), labels=list(self.mappings['NER_BIO'].keys()))
		pylab.colorbar()
