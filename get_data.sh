...
wget --no-check-certificate --no-proxy 'https://s3-eu-west-1.amazonaws.com/bootstrap-ner/semeval/train.txt' --directory-prefix=./data/sensor_corpus/
wget --no-check-certificate --no-proxy 'https://s3-eu-west-1.amazonaws.com/bootstrap-ner/semeval/dev.txt' --directory-prefix=./data/sensor_corpus/
wget --no-check-certificate --no-proxy 'https://s3-eu-west-1.amazonaws.com/bootstrap-ner/semeval/test.txt' --directory-prefix=./data/sensor_corpus/

wget --no-check-certificate --no-proxy 'https://s3-eu-west-1.amazonaws.com/bootstrap-ner/science/train.txt' --directory-prefix=./data/sensor_corpus/
wget --no-check-certificate --no-proxy 'https://s3-eu-west-1.amazonaws.com/bootstrap-ner/science/dev.txt' --directory-prefix=./data/sensor_corpus/
wget --no-check-certificate --no-proxy 'https://s3-eu-west-1.amazonaws.com/bootstrap-ner/science/test.txt' --directory-prefix=./data/sensor_corpus/
